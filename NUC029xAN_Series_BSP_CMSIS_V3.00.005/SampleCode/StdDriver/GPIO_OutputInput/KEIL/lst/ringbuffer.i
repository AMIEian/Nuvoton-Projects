#line 1 "..\\Modbus_Master_LIB\\ringbuffer.c"
...
#line 2 "..\\Modbus_Master_LIB\\ringbuffer.c"
...
uint8_t rbPop(RingBuffer *pRingBuff)
{
    if (pRingBuff->rp == pRingBuff->wp) return 0;  

    uint8_t ret = *(pRingBuff->rp++);

    if (pRingBuff->rp == pRingBuff->pEnd)
    {
        pRingBuff->rp -= pRingBuff->length; 
    }
