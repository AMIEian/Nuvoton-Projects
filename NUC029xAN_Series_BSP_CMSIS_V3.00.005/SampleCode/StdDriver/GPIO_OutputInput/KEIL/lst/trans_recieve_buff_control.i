#line 1 "..\\Modbus_Master_LIB\\trans_recieve_buff_control.c"
...
#line 2 "..\\Modbus_Master_LIB\\trans_recieve_buff_control.c"
#line 1 "..\\Modbus_Master_LIB\\ringbuffer.h"
...
#line 9 "..\\Modbus_Master_LIB\\ringbuffer.h"
...
#line 10 "..\\Modbus_Master_LIB\\ringbuffer.h"
...
#line 3 "..\\Modbus_Master_LIB\\trans_recieve_buff_control.c"
...
uint8_t Modbus_Master_GetByte(uint8_t  *getbyte)
{
    ...
    if (UART_Read(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), (uint8_t *)getbyte, 1) == 1)
        return HAL_OK;
    else
        return HAL_ERROR;
}
...
uint8_t Modbus_Master_Write(uint8_t *buf, uint8_t length)
{
    UART_Write(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), (uint8_t *)buf, length);
    return HAL_OK;
}
