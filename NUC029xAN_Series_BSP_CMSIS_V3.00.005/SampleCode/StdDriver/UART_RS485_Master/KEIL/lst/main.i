...
void RS485_SendAddressByte(uint8_t u8data)
{
    ...
    UART_SetLine_Config(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)), 0, (3), (0x5 << 3), (0x0 << 2));
...
void RS485_SendDataByte(uint8_t *pu8TxBuf, uint32_t u32WriteBytes)
{
    ...
    UART_SetLine_Config(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)), 0, (3), (0x7 << 3), (0x0 << 2));
...
void RS485_9bitModeMaster()
{
    ...
    UART_SelectRS485Mode(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)), (1ul << 10), 0);

     
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->MCR &= ~(1ul << 9);
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->MCR |= (0x0 << 9);
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((1UL<<30)|(0x1<<28)|(0x3<<25) |(24<<20)|(0x0<<18)|(0x0F<<10) |( 8<<5)|17));

     
    CLK_SetModuleClock(((1UL<<30)|(0x1<<28)|(0x3<<25) |(24<<20)|(0x0<<18)|(0x0F<<10) |( 8<<5)|16), 0x00000000UL, (((1)-1) << 8));
    CLK_SetModuleClock(((1UL<<30)|(0x1<<28)|(0x3<<25) |(24<<20)|(0x0<<18)|(0x0F<<10) |( 8<<5)|17), 0x00000000UL, (((1)-1) << 8));
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P0_MFP = ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P0_MFP & (~0x02000202UL) | 0x00000200UL;
