...
void UART0_Init(void)
{
    ...
    UART_Open(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), 57600);

     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->INTEN |= (0x1ul << (0));
...
void Timer_Init(void)
{
    ...
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000)), (1UL << (27)), 1000);
...
{
    if (TIMER_GetIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000))) == 1)
    {
