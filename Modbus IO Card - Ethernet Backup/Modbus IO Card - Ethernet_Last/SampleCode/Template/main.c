...
volatile char totalRegsToRead = 52;//64;
volatile char toatalDataBytesToReceived = 104;//128;	// 2 * totalRegsToRead
volatile char responceSize = 107;//131;	//	toatalBytesToReceived + 3
...
int main(void)
	{
			...
			/* Open Timer0 frequency to 8 Hz in periodic mode, and enable interrupt */
