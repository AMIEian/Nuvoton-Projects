...
volatile char totalRegsToRead = 52;
volatile char toatalDataBytesToReceived = 104;
volatile char responceSize = 107;
			...
			if(TIMER_GetIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))) == 1)
				{
						...
						if(dataReceiving == 0)
							{
								if(boardID == 1 || boardID == 11 || boardID == 21 || boardID == 31)
									{
...
int main(void)
	{
			...
			TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), (1UL << 27), 8);
