...
#line 12 "..\\int_handler.c"
#line 13 "..\\int_handler.c"
#line 14 "..\\int_handler.c"

void TMR0_IRQHandler(void)
{
    if (TIMER_GetIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x50000))))
    {
...
void UART0_IRQHandler(void)
{
    ...
    uint32_t u32IntSts = ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->INTSTS;
    uint32_t u32WKSts  = ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->WKSTS;
    ...
    {
        ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS = ((0x1ul << (1)) | (0x1ul << (2)));
    }
    ...
    if (u32IntSts & (0x1ul << (3)))
    {
        ...
        UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), (0x1ul << (11)));
    }

     
    if (u32IntSts & (0x1ul << (2)))
    {
        if (((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (6)))
            printf("\n BIF \n");

        if (((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (5)))
            printf("\n FEF \n");

        if (((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (4)))
            printf("\n PEF \n");

        u32Data = ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT; 
        printf("\n Error Data is '0x%x' \n", u32Data);
        UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), (0x1ul << (10)));
    }

    if ((u32IntSts & (0x1ul << (8))) || (u32IntSts & (0x1ul << (12)))) 
    {
         
        while (!((((UART_T *) ((( uint32_t)0x40000000) + 0x70000)))->FIFOSTS & (0x1ul << (14))))
        {
    ...
    {
        printf("\nBuffer Error...\n");
        UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), (0x1ul << (13)));
    }
    ...
    if (u32IntSts & (0x1ul << (6)))
    {
        printf("\n UART Wake-Up ");
        ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->INTSTS = (0x1ul << (6));
        UART_ClearIntFlag(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), (0x1ul << (14)));
    }
