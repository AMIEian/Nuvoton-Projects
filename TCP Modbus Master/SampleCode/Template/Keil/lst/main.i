...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK = (1ul << 16) | (1ul << 2) | (1ul << 17);
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P3_MFP |= (0x00000001UL | 0x00000002UL);
		...
		((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P1_MFP &= ~(0x00000404UL | 0x00000808UL);
					...
					if(dataReceived == 1)
						{
							...
							for(i = 0; i < 15; i++)
								{
									(((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->THR = (responce[i]));
								}
							dataReceived = 0;
						}
				}
