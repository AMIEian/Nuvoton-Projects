					...
					if(dataReceived == 1)
						{
							if(boardID == 1)
								{
									outp8(P1,responce[FIRST_REG_L]);
									outp8(P2,responce[FIRST_REG_H]);
									outp8(P3,responce[SECOND_REG_L]);
									outp8(P4,responce[SECOND_REG_H]);
								}
							else if(boardID == 2)
								{
									outp8(P1,responce[THIRD_REG_L]);
									outp8(P2,responce[THIRD_REG_H]);
									outp8(P3,responce[FOURTH_REG_L]);
									outp8(P4,responce[FOURTH_REG_H]);
								}
							else if(boardID == 3)
								{
									outp8(P1,responce[FIFTH_REG_L]);
									outp8(P2,responce[FIFTH_REG_H]);
									outp8(P3,responce[SIXTH_REG_L]);
									outp8(P4,responce[SIXTH_REG_H]);
								}
							dataReceived = 0;
						}
				}
